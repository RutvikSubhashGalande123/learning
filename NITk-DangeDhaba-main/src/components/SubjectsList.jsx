    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            Get ready to experience education like never before with ARez! Our
            augmented reality app lets you explore and interact with 3D models
            of real-world objects, bringing your learning to life.
          </Text>
        </Stack>
        <Container
          maxW={{ base: "5xl", md: "8xl" }}
          mt={12}
        >
          <Flex
            ...
            >
              ...
              <Stack>
                <CardBody>
                  ...
                  <Text py="2">
                    The study of matter, energy, and their interactions in the
                    universe.
                  </Text>
                </CardBody>
            ...
            >
              ...
              <Stack>
                <CardBody>
                  ...
                  <Text py="2">
                    The study of living organisms and their interactions with
                    the environment.
                  </Text>
                </CardBody>
            ...
            >
              ...
              <Stack>
                <CardBody>
                  ...
                  <Text py="2">
                    The study of the composition, structure, properties, and
                    reactions of matter.
                  </Text>
                </CardBody>
